...
using SiteNewsApiML.Model.DataModels;
using Microsoft.ML.Trainers;

namespace SiteNewsApiML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\rusa1\Desktop\wikipedia-detox-250-line-data.tsv.tsv";
        private static string MODEL_FILEPATH = @"../../../../SiteNewsApiML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.SgdCalibrated(new SgdCalibratedTrainer.Options() { L2Regularization = 1E-06f, ConvergenceTolerance = 0, 001f, NumberOfIterations = 10, Shuffle = true, LabelColumnName = "Sentiment", FeatureColumnName = "Features" });
